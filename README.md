...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-15 12:11`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6852982a-6c5c-4846-a7d5-a93e5be518df.git
$ cd 6852982a-6c5c-4846-a7d5-a93e5be518df
```
